...
public class GidsFileSystem extends ApplicationFile {
    ...
    public void authenticateAction(File file, byte flag_operation) throws ISOException {
        ...
        file.CheckPermission(pinManager, flag_operation);
    }
    ...
    public File getSafeFile(byte[] fci, short offset, short length) throws ISOException, InvalidArgumentsException, NotFoundException {
        ...
        if(fileDescByte  == 0x39) {
            ...
            authenticateAction(((DedicatedFile)currentlySelectedFiles[OFFSET_CURRENT_DF]), ACL_OP_DF_CREATE_EF);
    ...
    public void processDeleteFile(APDU apdu) throws ISOException {
        ...
        // Permissions.
        authenticateAction(fileToDelete, ACL_OP_EF_DELETE);
	...
	public void processGetData(APDU apdu) {
        ...
        authenticateAction(file, ACL_OP_DO_GET_DATA);
	...
	public void processPutData(APDU apdu) {
        ...
        authenticateAction(file, ACL_OP_DO_PUT_DATA);
	...
	public void processActivateFile(APDU apdu) throws ISOException {
    	...
    	authenticateAction(file, ACL_OP_EF_ACTIVATE);
